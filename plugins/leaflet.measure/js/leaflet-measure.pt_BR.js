! function(e) {
    ...
    L.Control.Measure = L.Control.extend({
        ...
        _getMeasurementDisplayStrings: function(e) {
            ...
            function r(e, t, r, n) {
                var o = { acres: "Acres", feet: "Pés", kilometers: "Quilômetros", hectares: "Hectares", meters: "Metros", miles: "Milhas", sqfeet: "Pés²", sqmeters: "Metros²", sqmiles: "Milhas²" },
    ...
    function n(e, t, r) {
        ...
        var j, x, M = o({}, t.imports, n.imports, a),
            ...
            P = t.interpolate || b,
            k = "__p += '",
            E = RegExp((t.escape || b).source + "|" + P.source + "|" + (P === p ? g : b).source + "|" + (t.evaluate || b).source + "|$", "g"),
            C = "sourceURL" in t ? "//# sourceURL=" + t.sourceURL + "\n" : "";
        e.replace(E, function(t, r, n, o, i, s) { return n || (n = o), k += e.slice(O, s).replace(_, u), r && (j = !0, k += "' +\n__e(" + r + ") +\n'"), i && (x = !0, k += "';\n" + i + ";\n__p += '"), n && (k += "' +\n((__t = (" + n + ")) == null ? '' : __t) +\n'"), O = s + t.length, t }), k += "';\n";
        var S = t.variable;
        S || (k = "with (obj) {\n" + k + "\n}\n"), k = (x ? k.replace(m, "") : k).replace(y, "$1").replace(v, "$1;"), k = "function(" + (S || "obj") + ") {\n" + (S ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (j ? ", __e = _.escape" : "") + (x ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + k + "return __p\n}";
        var A = i(function() { return Function(w, C + "return " + k).apply(void 0, L) });
...
}, function(e, t, r) { e.exports = '<a id="medidas" class="{{ model.className }}-toggle js-toggle" href=# title="Mede distâncias e áreas">Medidas</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h6>Mede distâncias e áreas</h6> <ul class=tasks> <a href=# class="js-start start">Criar nova medida</a> </ul> </div> <div class=js-measuringprompt> <h6>Mede distâncias e áreas</h6> <p class=js-starthelp>Comece criando uma medida, adicionando pontos no mapa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancelar</a></li> <li><a href=# class="js-finish finish">Finalizar medida</a></li> </ul> </div> </div> ' }, function(e, t, r) { e.exports = '<div class=group> <p class="lastpoint heading">Último ponto</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distância</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Área</span> {{ model.areaDisplay }}</p> </div> <% } %> ' }, function(e, t, r) { e.exports = '<h6>Localização do ponto</h6> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta localização</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ' }, function(e, t, r) { e.exports = '<h6><span>Medida linear</span></h6> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta linha</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ' }, function(e, t, r) { e.exports = '<h6><span>Medida de área</span></h6> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perímetro</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta área</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ' }]);