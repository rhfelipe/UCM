...
$query1 = 'SELECT DISTINCT setor, departamen FROM ';
$query2 = ' WHERE setor ILIKE '; 
$query3 = ' OR departamen ILIKE ';
//FILTRO POR CAMPUS
...
//AQUI SÃO ADICIONADAS AO VETOR AS PALAVRAS ENCONTRADAS QUE AINDA NÃO FORAM SALVAS
         foreach ($andar as $value) {
             $filtro = $query1.$campus[$i].'.'.$value[0].$query2.$key.$query3.$key; //filtro da consulta principal
